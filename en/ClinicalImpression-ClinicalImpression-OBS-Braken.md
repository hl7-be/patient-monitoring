# ClinicalImpression: Symptom - Vomiting - Patient Monitoring Outcome FHIR Implementation Guide v0.1.0

## Example ClinicalImpression: ClinicalImpression: Symptom - Vomiting
...
```json
{
  ...
  "id" : "ClinicalImpression-OBS-Braken",
  "status" : "completed",
  "description" : "Side effect assessment during OPAT home hospitalization: vomiting",
  "subject" : {
