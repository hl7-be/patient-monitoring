# Observation: Body Weight (Registered by Patient) - Patient Monitoring Outcome FHIR Implementation Guide v0.1.0

## Example Observation: Observation: Body Weight (Registered by Patient)
