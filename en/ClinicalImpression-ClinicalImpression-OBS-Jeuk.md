# ClinicalImpression: Symptom - Itching - Patient Monitoring Outcome FHIR Implementation Guide v0.1.0

## Example ClinicalImpression: ClinicalImpression: Symptom - Itching
...
```json
{
  ...
  "id" : "ClinicalImpression-OBS-Jeuk",
  "status" : "completed",
  "description" : "Side effect assessment during OPAT home hospitalization: itching",
  "subject" : {
