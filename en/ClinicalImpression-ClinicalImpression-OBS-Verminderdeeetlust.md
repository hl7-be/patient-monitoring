# ClinicalImpression: Symptom - Reduced Appetite - Patient Monitoring Outcome FHIR Implementation Guide v0.1.0

## Example ClinicalImpression: ClinicalImpression: Symptom - Reduced Appetite
...
```json
{
  ...
  "id" : "ClinicalImpression-OBS-Verminderdeeetlust",
  "status" : "completed",
  "description" : "Side effect assessment during OPAT home hospitalization: reduced appetite",
  "subject" : {
