# ClinicalImpression: Symptom - Diarrhea - Patient Monitoring Outcome FHIR Implementation Guide v0.1.0

## Example ClinicalImpression: ClinicalImpression: Symptom - Diarrhea
...
```json
{
  ...
  "id" : "ClinicalImpression-OBS-Diarree",
  "status" : "completed",
  "description" : "Side effect assessment during OPAT home hospitalization: diarrhea",
  "subject" : {
