# ClinicalImpression: Symptom - Chills - Patient Monitoring Outcome FHIR Implementation Guide v0.1.0

## Example ClinicalImpression: ClinicalImpression: Symptom - Chills
...
```json
{
  ...
  "id" : "ClinicalImpression-OBS-Rillingen",
  "status" : "completed",
  "description" : "Side effect assessment during OPAT home hospitalization: chills",
  "subject" : {
