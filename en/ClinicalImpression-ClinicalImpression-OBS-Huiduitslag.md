# ClinicalImpression: Symptom - Rash - Patient Monitoring Outcome FHIR Implementation Guide v0.1.0

## Example ClinicalImpression: ClinicalImpression: Symptom - Rash
...
```json
{
  ...
  "id" : "ClinicalImpression-OBS-Huiduitslag",
  "status" : "completed",
  "description" : "Side effect assessment during OPAT home hospitalization: rash",
  "subject" : {
