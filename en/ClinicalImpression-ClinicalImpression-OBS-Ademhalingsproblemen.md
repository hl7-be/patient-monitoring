# ClinicalImpression: Symptom - Respiratory Problems - Patient Monitoring Outcome FHIR Implementation Guide v0.1.0

## Example ClinicalImpression: ClinicalImpression: Symptom - Respiratory Problems
...
```json
{
  ...
  "id" : "ClinicalImpression-OBS-Ademhalingsproblemen",
  "status" : "completed",
  "description" : "Side effect assessment during OPAT home hospitalization: respiratory problems",
  "subject" : {
