# ClinicalImpression: Symptom - Candidiasis - Patient Monitoring Outcome FHIR Implementation Guide v0.1.0

## Example ClinicalImpression: ClinicalImpression: Symptom - Candidiasis
