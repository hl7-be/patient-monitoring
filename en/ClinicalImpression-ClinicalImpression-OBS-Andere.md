# ClinicalImpression: Symptom - Other - Patient Monitoring Outcome FHIR Implementation Guide v0.1.0

## Example ClinicalImpression: ClinicalImpression: Symptom - Other
...
```json
{
  ...
  "id" : "ClinicalImpression-OBS-Andere",
  "status" : "completed",
  "description" : "Side effect assessment during OPAT home hospitalization: other symptom",
  "subject" : {
