# ClinicalImpression: Symptom - Pain - Patient Monitoring Outcome FHIR Implementation Guide v0.1.0

## Example ClinicalImpression: ClinicalImpression: Symptom - Pain
...
```json
{
  ...
  "id" : "ClinicalImpression-OBS-Pijn",
  "status" : "completed",
  "description" : "Side effect assessment during OPAT home hospitalization: pain",
  "subject" : {
