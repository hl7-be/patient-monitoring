# Encounter: Home Hospitalization (Subcutaneous Injection) - Patient Monitoring Outcome FHIR Implementation Guide v0.1.0

## Example Encounter: Encounter: Home Hospitalization (Subcutaneous Injection)
