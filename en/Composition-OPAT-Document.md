# Composition: OPAT Document - Patient Monitoring Outcome FHIR Implementation Guide v0.1.0

## Example Composition: Composition: OPAT Document
...
```json
{
  ...
  {
    "title" : "Care team contact details",
    "author" : [{
      "reference" : "Organization/Organization-UZL"
    }],
    "entry" : [{
  ...
  {
    "title" : "Upcoming hospital appointments at UZL",
    "author" : [{
      "reference" : "Organization/Organization-UZL"
    }],
    "entry" : [{
  ...
  },
  {
    ...
    "text" : {
      "status" : "empty",
      "div" : "<div xmlns=\"http://www.w3.org/1999/xhtml\">No data available</div>"
    },
    "emptyReason" : {
      "coding" : [{
  ...
  {
    "title" : "Side effects / symptom burden",
    "author" : [{
      "reference" : "Organization/Organization-UZL"
    }],
    "entry" : [{
