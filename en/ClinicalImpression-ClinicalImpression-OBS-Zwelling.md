# ClinicalImpression: Symptom - Swelling - Patient Monitoring Outcome FHIR Implementation Guide v0.1.0

## Example ClinicalImpression: ClinicalImpression: Symptom - Swelling
...
```json
{
  ...
  "id" : "ClinicalImpression-OBS-Zwelling",
  "status" : "completed",
  "description" : "Side effect assessment during OPAT home hospitalization: swelling",
  "subject" : {
