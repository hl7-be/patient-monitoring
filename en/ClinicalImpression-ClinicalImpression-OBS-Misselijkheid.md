# ClinicalImpression: Symptom - Nausea - Patient Monitoring Outcome FHIR Implementation Guide v0.1.0

## Example ClinicalImpression: ClinicalImpression: Symptom - Nausea
...
```json
{
  ...
  "id" : "ClinicalImpression-OBS-Misselijkheid",
  "status" : "completed",
  "description" : "Side effect assessment during OPAT home hospitalization: nausea",
  "subject" : {
