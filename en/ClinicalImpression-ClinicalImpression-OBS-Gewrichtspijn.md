# ClinicalImpression: Symptom - Joint Pain - Patient Monitoring Outcome FHIR Implementation Guide v0.1.0

## Example ClinicalImpression: ClinicalImpression: Symptom - Joint Pain
...
```json
{
  ...
  "id" : "ClinicalImpression-OBS-Gewrichtspijn",
  "status" : "completed",
  "description" : "Side effect assessment during OPAT home hospitalization: joint pain",
  "subject" : {
