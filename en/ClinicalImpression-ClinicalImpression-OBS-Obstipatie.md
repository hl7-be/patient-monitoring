# ClinicalImpression: Symptom - Constipation - Patient Monitoring Outcome FHIR Implementation Guide v0.1.0

## Example ClinicalImpression: ClinicalImpression: Symptom - Constipation
...
```json
{
  ...
  "id" : "ClinicalImpression-OBS-Obstipatie",
  "status" : "completed",
  "description" : "Side effect assessment during OPAT home hospitalization: constipation",
  "subject" : {
