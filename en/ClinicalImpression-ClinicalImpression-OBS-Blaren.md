# ClinicalImpression: Symptom - Blisters - Patient Monitoring Outcome FHIR Implementation Guide v0.1.0

## Example ClinicalImpression: ClinicalImpression: Symptom - Blisters
...
```json
{
  ...
  "id" : "ClinicalImpression-OBS-Blaren",
  "status" : "completed",
  "description" : "Side effect assessment during OPAT home hospitalization: blisters",
  "subject" : {
