...
Instance: HomehospOpatContinuousInfusionQuestionnaireDefinition
InstanceOf: HomehospOpatContinuousInfusionQuestionnaire
Title: "Questionnaire: OPAT Continuous Infusion Home Hospitalization"
...
Usage: #definition
* url = "http://hl7belgium.org/fhir/patient-monitoring/Questionnaire/homehosp-opat-continuous-infusion"
* id = "homehosp-opat-continuous-infusion"
* name = "HomehospOpatContinuousInfusionQuestionnaireDefinition"
...
* item[nursingAssessment].item[=].item[+].linkId = "B3_FullInfusorWeight"
* item[nursingAssessment].item[=].item[=].text = "Gewicht van volle Infusor net voor nieuwe toediening"
...
* item[nursingAssessment].item[=].item[=].extension.valueCoding = $unitsofmeasure#g "g"

* item[nursingAssessment].item[=].item[+].linkId = "B4_EmptyInfusorWeight"
* item[nursingAssessment].item[=].item[=].text = "Gewicht bij afkoppelen van lege infusor"
* item[nursingAssessment].item[=].item[=].type = #decimal
* item[nursingAssessment].item[=].item[=].required = true
* item[nursingAssessment].item[=].item[=].extension.url = "http://hl7.org/fhir/StructureDefinition/questionnaire-unit"
* item[nursingAssessment].item[=].item[=].extension.valueCoding = $unitsofmeasure#g "g"

* item[nursingAssessment].item[=].item[+].linkId = "B5_AdditionalObservation"
* item[nursingAssessment].item[=].item[=].text = "Bijkomende observatie:(indien van toepassing)"
* item[nursingAssessment].item[=].item[=].type = #string
* item[nursingAssessment].item[=].item[=].code = $sct#396078004 "Medication prefill preparation management"
...
* item[nursingAssessment].item[=].item[+].linkId = "G_CatheterType"
