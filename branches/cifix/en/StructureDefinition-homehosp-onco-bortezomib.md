...
* Examples for this Profile: [BortezomibV1](Questionnaire-BortezomibV1.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.be.patient-monitoring|current/StructureDefinition/homehosp-onco-bortezomib)
