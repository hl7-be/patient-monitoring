# OPAT appointment example - Patient Monitoring Outcome FHIR Implementation Guide v0.1.0

## Example Appointment: OPAT appointment example
...
> **participant****actor**: [Location UZ Leuven - Raadpleging](Location-testloc.md)**status**: Accepted
