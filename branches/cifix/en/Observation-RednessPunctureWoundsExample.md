# Redness puncture wounds example - Patient Monitoring Outcome FHIR Implementation Guide v0.1.0

## Example Observation: Redness puncture wounds example
...
```json
{
  ...
  "id" : "RednessPunctureWoundsExample",
  "contained" : [{
