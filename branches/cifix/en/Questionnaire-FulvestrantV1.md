...
```json
{
  ...
  "item" : [{
    ...
    },
    {
      ...
      {
        "linkId" : "C6_BeslissingSpecifieer",
        "code" : [{
          "system" : "http://snomed.info/sct",
          "code" : "1156698007",
    ...
    },
    {
      ...
      {
        "linkId" : "D11_SpierEnGewrichtspijn",
        "code" : [{
          "system" : "http://snomed.info/sct",
          "code" : "57676002",
          "display" : "Joint pain"
