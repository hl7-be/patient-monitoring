...
```json
{
  ...
  "id" : "BortezomibV1",
  "meta" : {
    "profile" : ["http://hl7belgium.org/fhir/patient-monitoring/StructureDefinition/homehosp-onco-bortezomib"]
  },
  "url" : "http://hl7belgium.org/fhir/patient-monitoring/Questionnaire/BortezomibV1",
  "identifier" : [{
    "system" : "urn:ietf:rfc:3986",
    "value" : "urn:oid:2.16.840.1.113883.4.642.40.54.35.3"
  }],
  "version" : "0.1.0",
  "name" : "BortezomibV1",
  "title" : "Bortezomib",
  ...
  "item" : [{
    ...
    },
    {
      ...
      {
        "linkId" : "C6_ErnstSensorischeNeuropathie",
        "code" : [{
          "system" : "http://snomed.info/sct",
          "code" : "95662005",
          "display" : "Sensory neuropathy"
        }],
        "text" : "Ernstige sensorische neuropathie (bv. gevoelloosheid, tintelingen, brandend of koud gevoel in handen/voeten met pijn en/of impact op dagelijkse activiteiten)",
        "type" : "choice",
        "required" : true,
        "answerOption" : [{
          "valueCoding" : {
      ...
      {
        "linkId" : "C7_ErnstMotorisheNeuropathie",
        "code" : [{
          "system" : "http://snomed.info/sct",
          "code" : "299737009",
          "display" : "Lower motor neurone lesion"
        }],
        "text" : "Ernstige motorische neuropathie (bv. ernstige spierzwakte, algemene zwakte of tremor met impact op activiteiten zoals stappen of schrijven)",
        "type" : "choice",
        "required" : true,
        "answerOption" : [{
          "valueCoding" : {
      ...
      {
        "linkId" : "C10_BeslissingSpecifieer",
        "code" : [{
          "system" : "http://snomed.info/sct",
          "code" : "1156698007",
    ...
    },
    {
      ...
      {
        "linkId" : "D11_TintelingenGevoelloosheid",
        "code" : [{
          "system" : "http://snomed.info/sct",
          "code" : "91019004",
          "display" : "Paresthesia"
        }],
        "text" : "Tintelingen of gevoelloosheid in vingers of tenen",
        "type" : "choice",
        "answerOption" : [{
          "valueCoding" : {
            "system" : "http://snomed.info/sct",
      ...
      {
        "linkId" : "D12_MotorisischeNeuropathie",
        "code" : [{
          "system" : "http://snomed.info/sct",
          "code" : "95663000",
          "display" : "Motor neuropathy"
        }],
        "text" : "Motorische neuropathie (bv. spierzwakte of tremor)",
        "type" : "choice",
        "answerOption" : [{
          "valueCoding" : {
            "system" : "http://snomed.info/sct",
  ...
  },
  {
    ...
    "item" : [{
      ...
      {
        "linkId" : "E2_SpecifieerNee",
        "text" : "> Indien 'nee': specifieer",
        "type" : "string",
        "enableWhen" : [{
          "question" : "E1_ToedieningCorrect",
          "operator" : "=",
          "answerCoding" : {
            "system" : "http://snomed.info/sct",
            "code" : "373067005",
