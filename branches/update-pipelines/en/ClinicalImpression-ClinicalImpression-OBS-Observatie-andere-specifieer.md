# Symptoom: Observatie andere - specifieer - Patient Monitoring Outcome FHIR Implementation Guide v0.1.0

## Example ClinicalImpression: Symptoom: Observatie andere - specifieer
