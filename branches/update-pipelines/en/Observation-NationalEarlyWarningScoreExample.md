# National Early Warning Score example - Patient Monitoring Outcome FHIR Implementation Guide v0.1.0

## Example Observation: National Early Warning Score example
