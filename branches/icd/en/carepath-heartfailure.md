# Carepath Heart failure - Patient Monitoring Outcome FHIR Implementation Guide v0.1.0
...
**Carepath Identifier**: https://hl7belgium.org/fhir/patient-monitoring/carepath/heart-failure **Carepath Version**: 1.0.0
...
| | | |
| :--- | :--- | :--- |
| Fear or depression | ?? | [`Symptom Severity`](./ValueSet-symptom-severity.md) |
...
* [Blood Pressure Example - with bodySite](./Observation-BloodPressureExample2.md)
* [Weight Example](./Observation-BodyWeightExample.md)
* [Heart Rate Example](./Observation-HeartRateExample.md)
* [Reduced Appetite Example](./Observation-ReducedAppetiteExample.md)
