# Observation: Pain in Calves - Patient Monitoring Outcome FHIR Implementation Guide v0.1.0

## Example Observation: Observation: Pain in Calves

**status**: Final

**code**: Pain in muscle of lower leg
