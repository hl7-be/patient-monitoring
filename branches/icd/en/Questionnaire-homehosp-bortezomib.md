...
## Questionnaire: HomehospBortezomibQuestionnaireDefinition
Branch:
...
```json
{
  ...
  "status" : "active",
  "subjectType" : ["Patient"],
  "date" : "2026-09-22T07:17:16+00:00",
  ...
  "item" : [{
    ...
    },
    {
      ...
      {
        "linkId" : "C6_SevereSensoryNeuropathy",
        "code" : [{
          "system" : "http://snomed.info/sct",
          "code" : "95662005",
      ...
      {
        "linkId" : "C7_SevereMotorNeuropathy",
        "code" : [{
          "system" : "http://snomed.info/sct",
          "code" : "299737009",
    ...
    },
    {
      ...
      {
        "linkId" : "D12_MotorNeuropathy",
        "code" : [{
          "system" : "http://snomed.info/sct",
          "code" : "95663000",
          "display" : "Motor peripheral neuropathy"
        }],
  ...
  },
  {
    ...
    "item" : [{
      ...
      "type" : "group",
      "item" : [{
        "linkId" : "E1_AdministrationCorrect",
        "code" : [{
          "system" : "http://snomed.info/sct",
          "code" : "373149000",
      ...
      },
      {
        ...
        "type" : "string",
        "enableWhen" : [{
          "question" : "E1_AdministrationCorrect",
          "operator" : "=",
          "answerCoding" : {
            "system" : "http://snomed.info/sct",
            "code" : "373067005",
